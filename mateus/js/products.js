...
product.forEach(function (e) {
	...
	let image = "assets/img/" + e.dataset.image.split('/').pop();
	...
	// Caminho das imagens de cartões LOCAL
	if (offer == 'promo') cards = "assets/img/cards-dark.webp";
	else cards = "assets/img/cards.webp";
		...
		<div class="item ${offer}">
			<div class="wrapper">
				...
				<div class="item-buy">
					...
					<img src="${cards}" alt="Cards" class="card-flags">
				</div>
