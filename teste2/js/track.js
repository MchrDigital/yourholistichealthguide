...
var campaignID = "6a4c10a0a52f892988d8c50f";
...
var initialSrc = "https://tj.thrivejournall.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("tj.thrivejournall.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://tj.thrivejournall.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://tj.thrivejournall.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
